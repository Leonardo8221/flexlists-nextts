      ...
      <Stack spacing={5}>
        ...
        <Stack spacing={2.5}>
          <div>
            ...
            <Typography variant="overline" sx={{ mb: 2, color: 'text.disabled', display: 'block' }}>{description}</Typography>
          </div>
...
export default function LandingPricingPlans() {
  return (
    <RootStyle>
      <PriceImgStyle alt="overlay" src="/assets/home/pricingstyle.png" variants={varFadeInUp} />
      <Container maxWidth="lg">
        <Box sx={{ margin: 'auto', my: 10, textAlign: 'center', maxWidth: 650 }}>
