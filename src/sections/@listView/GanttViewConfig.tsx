...
function GanttViewConfig({ submit, updateConfig, columns, availableFieldUiTypes }: GanttViewConfigProps)
{
  ...
  const reloadColumns = () =>
  {
    ...
    updateGanttConfig(newTitleFields.length > 0 ? newTitleFields[0].id : 0, newColorFields.length > 0 ? newColorFields[0].id : 0, newLevelFields.length > 0 ? newLevelFields[0].id : 0, newFromFields.length > 0 ? newFromFields[0].id : 0, newToFields.length > 0 ? newToFields[0].id : 0);
  }
  ...
  const onTitleFieldChange = (event: SelectChangeEvent) => {
    ...
    updateGanttConfig(convertToInteger(value), colorFieldId, levelFieldId, fromFieldId, toFieldId);
  };
  ...
  const onColorFieldChange = (event: SelectChangeEvent) => {
    ...
    updateGanttConfig(titleFieldId, convertToInteger(value), levelFieldId, fromFieldId, toFieldId);
  };
  ...
  const onLevelFieldChange = (event: SelectChangeEvent) => {
    ...
    updateGanttConfig(titleFieldId, colorFieldId, convertToInteger(value), fromFieldId, toFieldId);
  };
  ...
  const onFromFieldChange = (event: SelectChangeEvent) => {
    ...
    updateGanttConfig(titleFieldId, colorFieldId, levelFieldId, convertToInteger(value), toFieldId);
  };
  ...
  const onToFieldChange = (event: SelectChangeEvent) => {
    ...
    updateGanttConfig(titleFieldId, colorFieldId, levelFieldId, fromFieldId, convertToInteger(value));
  };

  const updateGanttConfig = (newTitleFieldId: number, newColorId: number, newLevelId: number, newFromId: number, newToId: number) =>
  {
