...
export default function FieldFormPanel ({
    ...
    const handleSubmit = async() => {
      setSubmit(true);
      var updateViewFieldResponse = await fieldService.updateViewField(viewId,currentField.id,currentField.viewFieldColor,currentField.viewFieldName,currentField.viewFieldDetailsOnly,currentField.viewFieldVisible)
        ...
        <form onSubmit={(e) => e.preventDefault()}>
            ...
            >
              ...
              />
               <FormControlLabel
                  control={
                    <Checkbox checked={currentField.viewFieldDetailsOnly} onChange={onDetailsOnlyChange} name="required" />
                  }
                  label="DetailsOnly"
              />
              <FormControlLabel
                  control={
                    <Checkbox checked={currentField.viewFieldVisible} onChange={onVisibleChange} name="required" />
                  }
                  label="Visible"
                />
            </Stack>
