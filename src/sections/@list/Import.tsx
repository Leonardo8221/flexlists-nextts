  ...
  return (
    ...
    >
      <Box sx={style}>
        ...
        <Box sx={{ borderBottom: `1px solid ${theme.palette.palette_style.border.default}`, py: 2, display: 'grid', gridTemplateColumns: {xs: 'repeat(1, 1fr)', md: 'repeat(2, 1fr)'}, gap: '30px', rowGap: '12px', maxHeight: `${windowHeight - 100}px`, overflow: 'auto' }}>
        ...
        <Box sx={{ paddingTop: 2, cursor: 'pointer', textAlign: 'center', color: '#54A6FB' }}>View more options</Box>
      </Box>
    </Modal>
  );
};
