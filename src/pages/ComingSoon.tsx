...
export default function ComingSoon({ title, description, link }: ComingSoonProps) {
    ...
    return (
        <Box sx={{ position: "fixed", width: "100%", height: "100%", backgroundColor: "rgba(255,255,255,.1)", display: "grid", placeContent: "center", backdropFilter: "blur(10px)", transform: "translate3d(0,0,0)", zIndex: 999, textAlign: "center" }}> <Box sx={{ display: "flex", flexDirection: "column", gap: 4, maxWidth: 800 }}>
